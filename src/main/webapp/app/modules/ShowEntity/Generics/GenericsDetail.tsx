        ...
        <Table bordered>
          ...
          <tbody>
            <tr>
              ...
              <td className="text-center"><Link to={`/guest/ingredients/${ingredientsused?ingredientsused.id:''}`}>{ingredientsused?ingredientsused.iname:'No Ingredients Found'}</Link></td>
